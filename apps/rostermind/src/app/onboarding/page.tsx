            ...
            <form onSubmit={handleConnect} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-white/10 bg-zinc-800 px-4 py-3 text-white placeholder-zinc-500 outline-none transition focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
                  disabled={loading}
                  autoFocus
                />
              </div>
              ...
              {error && (
                <div className="rounded-lg border border-indigo-500/20 bg-indigo-500/10 px-4 py-3 text-sm text-indigo-400">
                  {error}
                </div>
              )}
          ...
          {platforms.map((platform) => (
            <div
              ...
              className={[
                ...
                platform.available
                  ? 'cursor-pointer border-white/10 bg-zinc-900 hover:border-indigo-500/50 hover:bg-indigo-500/5'
            ...
            >
              <div className={platform.available ? 'text-indigo-400' : 'text-zinc-600'}>
                {platform.logo}
              </div>
